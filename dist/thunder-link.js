...
window.thunderLink = function(e) {
  ...
  , function(e, t, n) {
    ...
    e.exports = {
      ...
      isBuffer: function(e) {
        return null !== e && !E(e) && null !== e.constructor && !E(e.constructor) && "function" == typeof e.constructor.isBuffer && e.constructor.isBuffer(e)
      },
      ...
      merge: function D() {
        var e = {};
        function t(t, n) {
          C(e[n]) && C(t) ? e[n] = D(e[n], t) : C(t) ? e[n] = D({}, t) : o(t) ? e[n] = t.slice() : e[n] = t
        }
  ...
  , function(e, t, n) {
    ...
    function p(e) {
      ...
      if (n.length > 0) {
        var r = n.eq(0);
        r.attr("content").indexOf("initial-scale=1") < 0 && (r.attr("content", "width=device-width, initial-scale=1"),
        r.attr("content", "width=device-width, initial-scale=" + 1 / t))
      } else
        j_xunlei_q("head").prepend('<meta name="viewport" content="width=device-width, initial-scale=' + 1 / t + '">');
  ...
  , function(e, t, n) {
    ...
    function u(e, t) {
      if (e)
        return D.base64Header + D.group;
      var n = t.split(".").pop().toLowerCase();
      return ".avi|.wmv|.mpeg|.mp4|.mov|.mkv|.flv|.f4v|.m4v|.rmvb|.rm|.3gp|.dat|.ts|.mts|.vob".indexOf(n) > -1 ? D.base64Header + D.video : ".mp3|.aac|.aiff|.amr|.m4p|.wav|.ogg|.raw|.dv".indexOf(n) > -1 ? D.base64Header + D.music : ".txt|.docx|.pptx|.xlsx".indexOf(n) > -1 ? D.base64Header + D.doc : ".exe|.ipa|.apk|.dmg|.bin|.pkg|.bat|.cmd|.com|.msi|.ins".indexOf(n) > -1 ? D.base64Header + D.soft : ".zip|.rar|.iso|.tgz|.tar".indexOf(n) > -1 ? D.base64Header + D.archive : ".png|.jpg|.bmp|.gif|.jpeg".indexOf(n) > -1 ? D.base64Header + D.image : D.base64Header + D.unknown
    }
    var A = null
      , l = {
      xlVersion: 0,
      ...
      generateTemplateForNotInstallOrNeedToUpate: function(e) {
        ...
        return '<div id="js_xl_popup_template" style="position: fixed; width:100%;height:100%; top:0;left:0;"><div class="xl_pop_tip" style="height:' + c + 'px" >    <div class="xl_main_tip">        <div class="xl_top_pop">            <div class="xl_head_pop">                <h3 class="xl_tit" style="text-align:left" >\u4e0b\u8f7d\u63d0\u793a</h3>                <div class="xl_wp_downjs">                    <a  href="https://open.thunderurl.com/#/" target="_blank" class="xl_btn_downjs"><i></i></a>                    <div class="xl_wp_downjs_tip">                        <p>\u70b9\u51fb\u4e86\u89e3\u201c\u8fc5\u96f7\u4e0b\u8f7dJS-SDK\u201d </p>                    </div>                </div>                <a href="javascript:;" class="xl_btn_clo hide_txt" id="js_xl_close_btn_of_not_install" clickid="windowclose">\u5173\u95ed<i></i></a>            </div>' + B + "        </div>" + l + "  </div>"
      },
      ...
      popup: function(e, t, n, r) {
        ...
        "old_browser_on_win" === e)
          ...
          var a = function(a) {
            var C = "";
            "string" == typeof t ? C = t : t && t.getAttribute(i) && (C = t.getAttribute(i));
            var s = l.generateTemplateForNotInstallOrNeedToUpate({
              fn: l.fn,
              isGroupTask: r,
              theme: e,
              thunderURL: t,
            ...
            var A = "install";
            "need_to_update_on_win" === e && (A = "update"),
            E.reportSend("page_pop", {
              clickid: "windowpc",
              if_qr_code: 1,
              pop_type: A,
              is_video_file: D ? 1 : 0
            ...
            j_xunlei_q("#js_xmp_manual_download_btn").bind("click", function() {
              try {
                if (n)
                  B({
                    tasks: l.tasks
            ...
            , C = l.fn.split("?")[0].split(".").pop().toLowerCase()
            , D = j_xunlei_q.inArray(C, ["avi", "rmvb", "rm", "divx", "mpg", "mpeg", "wmv", "mp4", "mkv"]) > -1
            , u = !1;
          l.xlVersion ? ((s(l.xlVersion, "10.1.1.0") > 0 || s(l.xlVersion, "9.0.0.0") < 0) && (u = D && "need_to_install_xmp" !== e),
          a(u)) : a(u = D && "need_to_install_xmp" !== e)
        }
      },
      ...
      copyText: function(e) {
        if (!("IE" === a() && C.getIEVersion() < 9)) {
          var t = n(11);
          t.isSupported() && (null != A && A.destroy(),
          A = new t(".btn_download, .js-xl-link",{
            text: function() {
              return e
            }
          }))
      ...
      init: function(e) {
        l.pid = e,
        j_xunlei_q("body").delegate("#js_xl_download_btn", "click", function() {
          setTimeout(function() {
            l.downloadXl(e);
        ...
        j_xunlei_q("body").delegate("#js_xl_close_btn_of_not_install", "click", function() {
        ...
        j_xunlei_q("body").delegate("#js_xl_iKnown_btn", "click", function() {
          l.hidnAllPopup()
        }),
        j_xunlei_q("body").delegate("#js_xl_manual_download_btn", "click", function() {
          E.reportSend("page_click", {
      ...
      openComfirm: function(e) {
        ...
        j_xunlei_q(".xl_ios_comfirm_wrapper .closeBtn").one("click", function(e) {
          "function" == typeof n && (n(e),
          j_xunlei_q(".xl_ios_comfirm_wrapper").remove())
        }),
        j_xunlei_q(".xl_ios_comfirm_wrapper .save").one("click", function(e) {
          "function" == typeof n && (j_xunlei_q(".xl_comfirm_wrapper").remove(),
          j_xunlei_q(".xl_ios_comfirm_wrapper").remove(),
          i(e))
        })
      }
  ...
  , function(e, t) {
    ...
    function r(e) {
      var t, n, r, o, E, a = "", C = "", s = "", B = 0;
      do {
        r = (t = e.charCodeAt(B++)) >> 2,
        o = (3 & t) << 4 | (n = e.charCodeAt(B++)) >> 4,
        E = (15 & n) << 2 | (C = e.charCodeAt(B++)) >> 6,
        s = 63 & C,
        isNaN(n) ? E = s = 64 : isNaN(C) && (s = 64),
        a = a + i.charAt(r) + i.charAt(o) + i.charAt(E) + i.charAt(s),
        t = n = C = "",
        r = o = E = s = ""
      } while (B < e.length);
      return a
    ...
    t.decode64 = function(e) {
      var t, n, r, o, E = "", a = "", C = "", s = 0;
      if (e.length % 4 != 0)
        return "";
      if (/[^A-Za-z0-9\+\/\=]/g.exec(e))
        return "";
      do {
        t = i.indexOf(e.charAt(s++)) << 2 | (r = i.indexOf(e.charAt(s++))) >> 4,
        n = (15 & r) << 4 | (o = i.indexOf(e.charAt(s++))) >> 2,
        a = (3 & o) << 6 | (C = i.indexOf(e.charAt(s++))),
        E += String.fromCharCode(t),
        64 != o && (E += String.fromCharCode(n)),
      ...
      return "thunder://" + r(function(e) {
        for (var t = e.length, i = "", r = 0; r < t; r++) {
          ...
          o > 255) {
            ...
            E >>= 8;
            var a = 255 & o;
            i += String.fromCharCode(E) + String.fromCharCode(a)
          } else
  ...
  , function(e, t, n) {
    ...
    var r, o, E = n(0), a = {};
    a.createUrlByParam = function(e, t) {
      var n = [];
      for (var i in t)
    ...
    a.createQrcode = function() {
      ...
      return function(n, r) {
        ...
        var D = !1
          ...
          , A = E.getUserBrowser()
          , l = E.getIEVersion()
          , c = ("IE" == A && l < 10 ? "http" : "https") + "://api-shoulei-ssl.xunlei.com/xlppc.dljgo.api/v2/create";
        function F() {
        ...
        j_xunlei_q.ajax({
          ...
          success: function(t) {
            clearTimeout(u),
            D || (t && "object" === i(t) && (e[C] = B = t.dlj),
            F())
          }
        })
      }
    }(),
    a.load_pc_xunlei_success = function(e) {}
    ,
    e.exports = a
  }
  , function(e, t, n) {
    (function(e) {
      ...
      o = function() {
        return function(e) {
          ...
          i = function(e, t) {
            ...
            var n = function(e) {
              ...
              , i = "function" == typeof Symbol && "symbol" == E(Symbol.iterator) ? function(e) {
              return E(e)
            }
            : function(e) {
        ...
        , function(e, t, n) {
          ...
          void 0 !== (o = "function" == typeof (i = function(e, t, n, i) {
            ...
            var a = r(t)
              , C = r(n)
              , s = r(i)
              , B = "function" == typeof Symbol && "symbol" == E(Symbol.iterator) ? function(e) {
              return E(e)
            }
            : function(e) {
              return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : E(e)
              ...
              return function(e, t) {
                if ("function" != typeof t && null !== t)
                  throw new TypeError("Super expression must either be null or a function, not " + E(t));
        ...
        , function(e, t, n) {
          function i(e, t, n, i, o) {
            ...
            return e.addEventListener(n, E, o),
            {
              destroy: function() {
                e.removeEventListener(n, E, o)
              }
            }
          }
          function r(e, t, n, i) {
      ...
      ,
      "object" == E(t) && "object" == E(e) ? e.exports = o() : (i = [],
      void 0 === (r = "function" == typeof (n = o) ? n.apply(t, i) : n) || (e.exports = r))
    }
    ).call(this, n(34)(e))
  }
  , function(e, t) {
  ...
  , function(e, t, n) {
    ...
    t.productAndroidShow = function(e, t) {
      ...
      e = C.createUrlByParam("xunleiapp://xunlei.com/sharePage", {
        type: "lianmeng",
        shareH5: "share_H5",
        h5Type: "h5_type",
        thunderPid: A,
      ...
      -1 === navigator.userAgent.indexOf("Android.Thunder") && function() {
        ...
        if (r.length > 0) {
          var o = r.eq(0);
          o.attr("content").indexOf("initial-scale=1") < 0 && (o.attr("content", "width=device-width, initial-scale=1"),
          o.attr("content", "width=device-width, initial-scale=" + 1 / e))
        } else
          j_xunlei_q("head").prepend('<meta name="viewport" content="width=device-width, initial-scale=' + 1 / e + '">');
        var E = '    <style>      .xl_android_tips{position: fixed;top: 50%;left: 50%;z-index: 2147483647;margin: 0;transform: translate(-50%,-50%);}       ._xl_andriod_show_2 ._xl_android_tips_con {position: relative;width: 94.26vw;padding-top: 82.024%;overflow: hidden;}       ._xl_andriod_show_2 ._xl_android_tips_con img {position: absolute;top: 0;left: 0;width: 100%;height: 100%;}       ._xl_andriod_show_2 .close {position: absolute;right: 5vw;top: 4vw;width: 12vw;height: 12vw;}    </style>    <div class="_xl_andriod_show_2" id="thunder_m_div"><a href="javascript:;"  blockid="lianmeng_mask" event_id="new_click" clickid="lianmengproductAndroidShow" id="AndroidDiv" ></a><div class="_xl_android_tips_con" id="thunder_dl_shoulei" clickid="download"><img src="' + i + '/img/pop2.png" /><a class="close" href="javascript:;" id="union_download_close" clickid="close"></a></div></div>';
        l.innerHTML = E,
      ...
      !1;
      function c() {
        return s.reportSend("page_click", {
          clickid: "launch"
        }),
      ...
      function F() {
        var t, n = window.location.host, i = a["default"].apk;
        a.server && (a.server[A] ? a.server[A].apk && (i = a.server[A].apk) : a.server[n] && a.server[n].apk && (i = a.server[n].apk)),
        window.location.href = e;
        var r = Date.now();
  ...
  , function(e, t, n) {
    ...
    n(7),
    n(5))
      , a = n(4).getFieIconBase64Data
      , C = null;
    function s(e, t, n, i) {
      function E() {
        j_xunlei_q("#js_xl_popup_panel").remove(),
        j_xunlei_q("body").undelegate("#js_xl_install_btn", "click", s),
        j_xunlei_q("body").undelegate("#js_xl_launch_btn", "click", B),
        j_xunlei_q("body").undelegate("#js_xl_close_btn", "click", E)
      }
      function s() {
        E(),
      ...
      j_xunlei_q("body").delegate("#js_xl_close_btn", "click", E),
      j_xunlei_q("body").delegate("#js_xl_install_btn", "click", s),
      j_xunlei_q("body").delegate("#js_xl_launch_btn", "click", B)
    }
    t.newMacTasks = function(e, t) {
      function r(e) {
        var t = n(11);
        t.isSupported() && (C = new t(".btn_launch_mac_thunder",{
          text: function() {
            return e
          }
        }))
      ...
      if (null != e.tasks && "object" === i(e.tasks)) {
        if (1 == e.tasks.length && null != e.tasks[0].url && /^\s*thunder:\/\//gi.test(e.tasks[0].url))
          s(e.tasks[0].url, 0, !1, t);
        else if (e.tasks.length > 1) {
          var o = "thunders://" + JSON.stringify(e).replace(/^\"|\"$/g, "").replace(/\\/g, "");
          try {
            s("thunder://QUFEdW1teUxpbmsvQ29weS1Gcm9tLUNsaXBib2FyZFpa", 0, !0, t),
            r(o)
          } catch (e) {
        ...
        try {
          s("thunder://QUFEdW1teUxpbmsvQ29weS1Gcm9tLUpTT05aWg==", 0, !0, t),
          r(o)
        } catch (e) {
          alert("\u5bf9\u4e0d\u8d77,\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u8be5\u64cd\u4f5c\uff01")
        }
  ...
  , function(e, t, n) {
    ...
    (function(t) {
      ...
      var a, C = {
        adapter: ("undefined" != typeof XMLHttpRequest ? a = n(21) : void 0 !== t && "[object process]" === Object.prototype.toString.call(t) && (a = n(21)),
        a),
        transformRequest: [function(e, t) {
          return r(t, "Accept"),
          r(t, "Content-Type"),
          i.isFormData(e) || i.isArrayBuffer(e) || i.isBuffer(e) || i.isStream(e) || i.isFile(e) || i.isBlob(e) ? e : i.isArrayBufferView(e) ? e.buffer : i.isURLSearchParams(e) ? (E(t, "application/x-www-form-urlencoded;charset=utf-8"),
          e.toString()) : i.isObject(e) ? (E(t, "application/json;charset=utf-8"),
          JSON.stringify(e)) : e
        }
        ],
      ...
      e.exports = function(e) {
        return new t(function(t, n) {
          ...
          if (e.auth) {
            ...
            u.Authorization = "Basic " + btoa(l + ":" + c)
          }
          var F = a(e.baseURL, e.url);
          if (A.open(e.method.toUpperCase(), E(F, e.params, e.paramsSerializer), !0),
          A.timeout = e.timeout,
          A.onreadystatechange = function() {
            if (A && 4 === A.readyState && (0 !== A.status || A.responseURL && 0 === A.responseURL.indexOf("file:"))) {
              var i = "getAllResponseHeaders"in A ? C(A.getAllResponseHeaders()) : null
                , o = {
          ...
          ,
          A.onabort = function() {
            A && (n(B("Request aborted", e, "ECONNABORTED", A)),
            A = null)
          }
          ,
          A.onerror = function() {
          ...
          A.ontimeout = function() {
            ...
            n(B(t, e, "ECONNABORTED", A)),
            A = null
          }
          ,
          i.isStandardBrowserEnv()) {
            var d = (e.withCredentials || s(F)) && e.xsrfCookieName ? o.read(e.xsrfCookieName) : void 0;
            d && (u[e.xsrfHeaderName] = d)
          }
          if ("setRequestHeader"in A && i.forEach(u, function(e, t) {
  ...
  , function(e, t, n) {
    ...
    var i = n(29)
      ...
      , E = n(3).playWithXmp
      , a = n(3).iPhoneDownload
      , C = n(56).saveToCloudPan
      , s = n(3).getXlVersion
      , B = n(3).getXmpVersion
      , D = n(14)
      , u = n(15)
      , A = n(8)
      , l = n(1).openThunderSchemeUrl
      , c = n(57)
      , F = n(0)
    ...
    y.newTask = function(e) {
      ...
      var t = d()
        ...
        , l = !1
        , c = "";
      if (void 0 !== e.thunderInstallPack && /^\s*https?:\/\/(.+?\.)?down\.sandai\.net/gi.test(e.thunderInstallPack) ? g.thunderInstallPack = e.thunderInstallPack : g.thunderInstallPack = void 0,
      void 0 !== e.json && -1 !== e.json.indexOf("http"))
        ...
        if (void 0 === e.tasks)
          return;
        if (!0 === (l = e.tasks.length > 1) ? null != e.taskGroupName && "" != e.taskGroupName && (c = e.taskGroupName,
        B = !0) : null != e.tasks[0].name && "" != e.tasks[0].name && (c = e.tasks[0].name),
      ...
      g.init(A.pid);
      try {
        r.get("//api-xl9-ssl.xunlei.com/xlws/partner/is_partner?union_id=".concat(A.pid)).then(function(r) {
          if (r.data.data.is_exist)
            l ? alert("\u672a\u652f\u6301\u6279\u91cf\u4e0b\u8f7d\u529f\u80fd\uff0c\u8bf7\u671f\u5f85\u540e\u7eed\u66f4\u65b0\u7684\u7248\u672c\u3002") : C(e.tasks[0].url, e.tasks[0].originUrl, c, A.pid);
          else if ("iPhone" == E || "iPad" == E || "iPod" == E)
            l ? alert("\u624b\u673a\u8fc5\u96f7\u6682\u672a\u652f\u6301\u6279\u91cf\u4e0b\u8f7d\u529f\u80fd\uff0c\u8bf7\u671f\u5f85\u540e\u7eed\u66f4\u65b0\u7684\u7248\u672c\u3002") : a(e.tasks[0].url, e.tasks[0].originUrl, c);
          else if ("MacBrowser" == t)
            u.newMacTasks(e, c);
          else if ("Android" == t)
            l ? alert("\u624b\u673a\u8fc5\u96f7\u6682\u672a\u652f\u6301\u6279\u91cf\u4e0b\u8f7d\u529f\u80fd\uff0c\u8bf7\u671f\u5f85\u540e\u7eed\u66f4\u65b0\u7684\u7248\u672c\u3002") : D.productAndroidShow(e.tasks[0].url, A.pid);
          else if (p() && ("IE" === t && n > 9 || "IE" !== t)) {
            var F = location.href.substring(0, 5);
            if ("IE" === t && "https" === F && n < 12)
              return g.copyText("thunderx://" + JSON.stringify(e)),
              void g.popup("not_install_on_win", l ? "" : e.tasks[0].url, l, B);
            s(A.pid, function(t) {
              var n = e.minVersion;
              ...
              t && f(t, n) >= 0)
                ...
                t && f(t, "9.0.0.0") >= 0 ? l ? (g.copyText("thunderx://" + JSON.stringify(e)),
                g.popup("need_to_update_on_win", l ? "" : e.tasks[0].url, l, B)) : o({
                  thunderPid: A.pid,
                  url: e.tasks[0].url,
                  createShortcut: e.createShortcut
                }) : (g.copyText("thunderx://" + JSON.stringify(e)),
                g.popup("not_install_on_win", l ? "" : e.tasks[0].url, l, B))
            })
          } else
            l ? p() ? g.popup("old_browser_on_win") : g.popup("old_system_on_win") : i.windowsDefaultHandler(e.tasks[0].url, A.pid),
            g.copyText("thunderx://" + JSON.stringify(e))
        })
      } catch (e) {
        console.error("err: ", e)
  ...
  , function(e, t) {
    ...
    !function(e, t) {
      ...
      function o(e, i, r, E, a, C) {
        ...
        if (r !== t) {
          for (E = !C && E && p.isFunction(r),
          B = 0; B < s; B++)
            a(e[B], i, E ? r.call(e[B], B, a(e[B], i)) : r, C);
          return e
        }
        return s ? a(e[0], i) : t
      }
      ...
      function B(e) {
        var t, n, i, r, o, E, a, C = [], s = [], B = arguments;
        if (i = p.data(this, "events"),
        e.liveFired !== this && i && i.live && (!e.button || "click" !== e.type)) {
          e.liveFired = this;
          var D = i.live.slice(0);
          for (o = 0; o < D.length; o++)
            (i = D[o]).origType.replace(q, "") === e.type ? s.push(i.selector) : D.splice(o--, 1);
          for (E = 0,
          a = (n = p(e.target).closest(s, e.currentTarget)).length; E < a; E++)
            for (o = 0; o < D.length; o++)
              i = D[o],
              n[E].selector === i.selector && (r = n[E].elem,
              s = null,
              "mouseenter" !== i.preType && "mouseleave" !== i.preType || (s = p(e.relatedTarget).closest(i.selector)[0]),
              s && s === r || C.push({
                elem: r,
                handleObj: i
              }));
        ...
        t.each(function() {
          if (this.nodeName === (e[n] && e[n].nodeName)) {
            ...
            if (t = t && t.events)
              ...
              t)
                for (var o in t[r])
                  p.event.add(this, r, t[r][o], t[r][o].data)
          }
        })
      }
      function l(e, t, n) {
        ...
        1 === e.length && "string" == typeof e[0] && e[0].length < 512 && t === v && !le.test(e[0]) && (p.support.checkClone || !ce.test(e[0])) && (r = !0,
        (o = p.fragments[e[0]]) && 1 !== o && (i = o)),
      ...
      function c(e, t) {
        var n = {};
        return p.each(Ze.concat.apply([], Ze.slice(0, t)), function() {
          n[this] = e
        }),
        n
      }
      ...
      }, f = e.jQuery, m = e.$, v = e.document, g = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, _ = /^.[^:#\[\.,]*$/, y = /\S/, b = /^(\s|\u00A0)+|(\s|\u00A0)+$/g, w = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, x = navigator.userAgent, k = !1, T = [], j = Object.prototype.toString, I = Object.prototype.hasOwnProperty, S = Array.prototype.push, N = Array.prototype.slice, M = Array.prototype.indexOf;
      p.fn = p.prototype = {
        init: function(e, n) {
          var i, r;
          if (!e)
          ...
          if ("string" == typeof e) {
            ...
            if (i[1])
              return r = n ? n.ownerDocument || n : v,
              (e = w.exec(e)) ? p.isPlainObject(n) ? (e = [v.createElement(e[1])],
        ...
        ready: function(e) {
          return p.bindReady(),
          p.isReady ? e.call(v, p) : T && T.push(e),
          this
        },
        eq: function(e) {
      ...
      p.extend = p.fn.extend = function() {
        var e, i, r, o, E = arguments[0] || {}, a = 1, C = arguments.length, s = !1;
        for ("boolean" == typeof E && (s = E,
        E = arguments[1] || {},
        a = 2),
        "object" === n(E) || p.isFunction(E) || (E = {}),
        C === a && (E = this,
        --a); a < C; a++)
          if (null != (e = arguments[a]))
            for (i in e)
              e.hasOwnProperty(i) && (r = E[i],
              E !== (o = e[i]) && (s && o && (p.isPlainObject(o) || p.isArray(o)) ? (r = r && (p.isPlainObject(r) || p.isArray(r)) ? r : p.isArray(o) ? [] : {},
              E[i] = p.extend(s, r, o)) : o !== t && (E[i] = o)));
        return E
      }
      ,
      p.extend({
        ...
        isPlainObject: function(e) {
          if (!e || "[object Object]" !== j.call(e) || e.nodeType || e.setInterval)
            return !1;
        ...
        each: function(e, n, i) {
          var r, o = 0, E = e.length, a = E === t || p.isFunction(e);
          if (i)
            if (a) {
              for (r in e)
                if (!1 === n.apply(e[r], i))
            ...
            for (i = e[0]; o < E && !1 !== n.call(i, o, i); i = e[++o])
              ;
          return e
        },
        trim: function(e) {
        ...
        map: function(e, t, n) {
          for (var i, r = [], o = 0, E = e.length; o < E; o++)
      ...
      : v.attachEvent && (h = function() {
        "complete" === v.readyState && (v.detachEvent("onreadystatechange", h),
        p.ready())
      }
      ),
      function() {
        ...
        if (o && o.length && a) {
          ...
          t.removeChild(n),
          i.attachEvent && i.fireEvent && (i.attachEvent("onclick", function E() {
            p.support.noCloneEvent = !1,
            i.detachEvent("onclick", E)
          }),
      ...
      p.extend({
        ...
        data: function(i, r, o) {
          if (!i.nodeName || !p.noData[i.nodeName.toLowerCase()]) {
            var E = (i = i == e ? R : i)[P]
              , a = p.cache;
            return E || "string" != typeof r || o !== t ? (E || (E = ++O),
            "object" === n(r) ? (i[P] = E,
            a[E] = p.extend(!0, {}, r)) : a[E] || (i[P] = E,
            a[E] = {}),
            i = a[E],
            o !== t && (i[r] = o),
        ...
        removeData: function(t, n) {
          if (!t.nodeName || !p.noData[t.nodeName.toLowerCase()]) {
            var i = (t = t == e ? R : t)[P]
              ...
              , o = r[i];
            n ? o && (delete o[n],
            p.isEmptyObject(o) && p.removeData(t)) : (p.support.deleteExpando ? delete t[p.expando] : t.removeAttribute && t.removeAttribute(p.expando),
            delete r[i])
          }
        }
      }),
      ...
      p.fn.extend({
        ...
        addClass: function(e) {
          ...
          if (e && "string" == typeof e)
            for (var t = (e || "").split(G), n = 0, i = this.length; n < i; n++) {
              var r = this[n];
              if (1 === r.nodeType)
                if (r.className) {
                  for (var o = " " + r.className + " ", E = r.className, a = 0, C = t.length; a < C; a++)
                    o.indexOf(" " + t[a] + " ") < 0 && (E += " " + t[a]);
                  r.className = p.trim(E)
                } else
                  r.className = e
            }
          return this
        ...
        removeClass: function(e) {
          ...
          if (e && "string" == typeof e || e === t)
            for (var n = (e || "").split(G), i = 0, r = this.length; i < r; i++) {
              var o = this[i];
              if (1 === o.nodeType && o.className)
                if (e) {
                  for (var E = (" " + o.className + " ").replace(L, " "), a = 0, C = n.length; a < C; a++)
                    E = E.replace(" " + n[a] + " ", " ");
                  o.className = p.trim(E)
                } else
                  o.className = ""
            }
          return this
        ...
        toggleClass: function(e, t) {
          ...
          return p.isFunction(e) ? this.each(function(n) {
            ...
            if ("string" === i)
              for (var n, o = 0, E = p(this), a = t, C = e.split(G); n = C[o++]; )
                a = r ? a : !E.hasClass(n),
                E[a ? "addClass" : "removeClass"](n);
            else
        ...
        val: function(e) {
          ...
          var C = p.isFunction(e);
          return this.each(function(t) {
            var n = p(this)
              , i = e;
            if (1 === this.nodeType)
              if (C && (i = e.call(this, t, n.val())),
              "number" == typeof i && (i += ""),
      ...
      p.extend({
        ...
        attr: function(e, n, i, r) {
          ...
          1 === e.nodeType) {
            var E = Y.test(n);
            return n in e && r && !E ? (o && ("type" === n && Q.test(e.nodeName) && e.parentNode && p.error("type property can't be changed"),
            e[n] = i),
            p.nodeName(e, "form") && e.getAttributeNode(n) ? e.getAttributeNode(n).nodeValue : "tabIndex" === n ? (n = e.getAttributeNode("tabIndex")) && n.specified ? n.value : W.test(e.nodeName) || H.test(e.nodeName) && e.href ? 0 : t : e[n]) : !p.support.style && r && "style" === n ? (o && (e.style.cssText = "" + i),
            e.style.cssText) : (o && e.setAttribute(n, "" + i),
            null === (e = !p.support.hrefNormalized && r && E ? e.getAttribute(n, 2) : e.getAttribute(n)) ? t : e)
          }
      ...
      p.event = {
        add: function(n, i, r, o) {
          ...
          r.handler && (r = (E = r).handler),
          r.guid || (r.guid = p.guid++),
          a = p.data(n))) {
            var C = a.events = a.events || {}
              , s = a.handle;
            s || (a.handle = s = function() {
              return void 0 === p || p.event.triggered ? t : p.event.handle.apply(s.elem, arguments)
            }
            ),
            s.elem = n,
            i = i.split(" ");
            for (var B, D, u = 0; B = i[u++]; ) {
              ...
              B.indexOf(".") > -1 ? (D = B.split("."),
              B = D.shift(),
              a.namespace = D.slice(0).sort().join(".")) : (D = [],
              a.namespace = ""),
              a.type = B,
              a.guid = r.guid;
              var A = C[B]
                , l = p.event.special[B] || {};
              A || (A = C[B] = [],
              l.setup && !1 !== l.setup.call(n, o, D, s) || (n.addEventListener ? n.addEventListener(B, s, !1) : n.attachEvent && n.attachEvent("on" + B, s))),
              l.add && (l.add.call(n, a),
        ...
        remove: function(e, t, n, i) {
          if (3 !== e.nodeType && 8 !== e.nodeType) {
            var r, o, E, a, C, s, B, D = 0, u = p.data(e), A = u && u.events;
            if (u && A)
              ...
              !t || "string" == typeof t && "." === t.charAt(0))
                ...
                for (t = t.split(" "); r = t[D++]; )
                  if (C = r,
                  E = [],
                  (o = r.indexOf(".") < 0) || (E = r.split("."),
                  r = E.shift(),
                  a = new RegExp("(^|\\.)" + p.map(E.slice(0).sort(), z).join("\\.(?:.*\\.)?") + "(\\.|$)")),
                  s = A[r])
                    if (n) {
                      for (C = p.event.special[r] || {},
                      l = i || 0; l < s.length && (B = s[l],
                      n.guid !== B.guid || ((o || a.test(B.namespace)) && (null == i && s.splice(l--, 1),
                      C.remove && C.remove.call(e, B)),
                      null == i)); l++)
                        ;
                      (0 === s.length || null != i && 1 === s.length) && (C.teardown && !1 !== C.teardown.call(e, E) || J(e, r, u.handle),
                      delete A[r])
                    } else
                      for (var l = 0; l < s.length; l++)
                        B = s[l],
                        (o || a.test(B.namespace)) && (p.event.remove(e, C, B.handler, l),
                        s.splice(l--, 1));
                p.isEmptyObject(A) && ((t = u.handle) && (t.elem = null),
                delete u.events,
                delete u.handle,
        ...
        trigger: function(e, i, r, o) {
          var E = e.type || e;
          if (!o) {
            if (e = "object" === n(e) ? e[P] ? e : p.extend(p.Event(E), e) : p.Event(E),
            E.indexOf("!") >= 0 && (e.type = E = E.slice(0, -1),
            e.exclusive = !0),
            r || (e.stopPropagation(),
            p.event.global[E] && p.each(p.cache, function() {
              this.events && this.events[E] && p.event.trigger(e, i, this.handle.elem)
            })),
          ...
          try {
            r && r.nodeName && p.noData[r.nodeName.toLowerCase()] || r["on" + E] && !1 === r["on" + E].apply(r, i) && (e.result = !1)
          } catch (e) {}
          if (!e.isPropagationStopped() && o)
            p.event.trigger(e, i, o, !0);
          else if (!e.isDefaultPrevented()) {
            o = e.target;
            var a, C = p.nodeName(o, "a") && "click" === E, s = p.event.special[E] || {};
            if (!(s._default && !1 !== s._default.call(r, e) || C || o && o.nodeName && p.noData[o.nodeName.toLowerCase()])) {
              try {
                o[E] && ((a = o["on" + E]) && (o["on" + E] = null),
                p.event.triggered = !0,
                o[E]())
              } catch (e) {}
              a && (o["on" + E] = a),
        ...
        handle: function(n) {
          ...
          n.type = r.shift(),
          o = new RegExp("(^|\\.)" + r.slice(0).sort().join("\\.(?:.*\\.)?") + "(\\.|$)")),
          r = (E = p.data(this, "events"))[n.type],
          E && r) {
            E = 0;
            for (var a = (r = r.slice(0)).length; E < a; E++) {
              var C = r[E];
              if ((i || o.test(C.namespace)) && (n.handler = C.handler,
              n.data = C.data,
              n.handleObj = C,
              (C = C.handler.apply(this, arguments)) !== t && (n.result = C,
              !1 === C && (n.preventDefault(),
              n.stopPropagation())),
        ...
        fix: function(e) {
          ...
          null == e.pageX && null != e.clientX && (n = v.documentElement,
          r = v.body,
      ...
      var J = v.removeEventListener ? function(e, t, n) {
      ...
      !p.support.changeBubbles) {
        var K, $ = /textarea|input|select/i, ee = function(e) {
          ...
          var i, r, o = e.target;
          if ($.test(o.nodeName) && !o.readOnly && (i = p.data(o, "_change_data"),
          r = ee(o),
          "focusout" === e.type && "radio" === o.type || p.data(o, "_change_data", r),
          i !== t && r !== i && (null != i || r)))
      ...
      p.each(["bind", "one"], function(e, i) {
        p.fn[i] = function(e, r, o) {
          ...
          p.isFunction(r) && (o = r,
          r = t);
          var a = "one" === i ? p.proxy(o, function(e) {
            return p(this).unbind(e, a),
          ...
          if ("unload" === e && "one" !== i)
            ...
            E = 0;
            for (var C = this.length; E < C; E++)
              p.event.add(this[E], e, a, r)
          }
          return this
        }
      }),
      ...
      p.each(["live", "die"], function(e, n) {
        p.fn[n] = function(e, i, r, o) {
          var E, a, C, s = 0, B = o || this.selector, u = o ? this : p(this.context);
          for (p.isFunction(i) && (r = i,
          i = t),
          e = (e || "").split(" "); null != (E = e[s++]); )
            a = "",
            (o = q.exec(E)) && (a = o[0],
            E = E.replace(q, "")),
            "hover" === E ? e.push("mouseenter" + a, "mouseleave" + a) : (C = E,
            "focus" === E || "blur" === E ? (e.push(ne[E] + a),
            E += a) : E = (ne[E] || E) + a,
            "live" === n ? u.each(function() {
              p.event.add(this, D(E, B), {
                data: i,
                selector: B,
                handler: r,
                origType: E,
      ...
      function() {
          ...
          for (var E = i.length; r < E; r++) {
            ...
            if (a) {
              ...
              for (var C = !1; a; ) {
                ...
                if (1 !== a.nodeType || o || (a.sizcache = n,
                a.sizset = r),
        ...
        var s = function(e, t, n, i) {
          ...
          if (!e || "string" != typeof e)
            return n;
          for (var a, C, u, A, l = [], p = !0, f = d(t), m = e; null !== (r.exec(""),
          a = r.exec(m)); )
            if (m = a[3],
            l.push(a[1]),
            a[2]) {
          ...
          if (l.length > 1 && D.exec(e))
            if (2 === l.length && B.relative[l[0]])
              C = h(l[0] + l[1], t);
            else
              for (C = B.relative[l[0]] ? [t] : s(l.shift(), t); l.length; )
                e = l.shift(),
                B.relative[e] && (e += l.shift()),
                C = h(e, C);
          else if (!i && l.length > 1 && 9 === t.nodeType && !f && B.match.ID.test(l[0]) && !B.match.ID.test(l[l.length - 1]) && (t = (a = s.find(l.shift(), t, f)).expr ? s.filter(a.expr, a.set)[0] : a.set[0]),
          t)
            for (C = (a = i ? {
              expr: l.pop(),
              set: c(i)
            } : s.find(l.pop(), 1 !== l.length || "~" !== l[0] && "+" !== l[0] || !t.parentNode ? t : t.parentNode, f)).expr ? s.filter(a.expr, a.set) : a.set,
            l.length > 0 ? u = c(C) : p = !1; l.length; ) {
              var g = l.pop();
              a = g,
              B.relative[g] ? a = l.pop() : g = "",
              null == a && (a = t),
              B.relative[g](u, a, f)
            }
          else
          ...
          if (u || (u = C),
          u || s.error(g || e),
          "[object Array]" === E.call(u))
            if (p)
              if (t && 1 === t.nodeType)
                for (e = 0; null != u[e]; e++)
                  u[e] && (!0 === u[e] || 1 === u[e].nodeType && F(t, u[e])) && n.push(C[e]);
              else
                for (e = 0; null != u[e]; e++)
                  u[e] && 1 === u[e].nodeType && n.push(C[e]);
            else
              n.push.apply(n, u);
          else
            c(u, n);
        ...
        s.find = function(e, t, n) {
          ...
          if (!e)
            return [];
          for (var o = 0, E = B.order.length; o < E; o++) {
            var a = B.order[o];
            if (r = B.leftMatch[a].exec(e)) {
              var C = r[1];
              if (r.splice(1, 1),
              "\\" !== C.substr(C.length - 1) && (r[1] = (r[1] || "").replace(/\\/g, ""),
              null != (i = B.find[a](r, t, n)))) {
                e = e.replace(B.match[a], "");
                break
              }
            }
          }
        ...
        ,
        s.filter = function(e, n, i, r) {
          for (var o, E, a = e, C = [], D = n, u = n && n[0] && d(n[0]); e && n.length; ) {
            for (var A in B.filter)
              if (null != (o = B.leftMatch[A].exec(e)) && o[2]) {
                var l, c, F = B.filter[A];
                if (c = o[1],
                E = !1,
                o.splice(1, 1),
                "\\" !== c.substr(c.length - 1)) {
                  if (D === C && (C = []),
                  B.preFilter[A])
                    if (o = B.preFilter[A](o, D, i, C, r, u)) {
                      if (!0 === o)
                        continue
                    } else
                      E = l = !0;
                  if (o)
                    for (var h = 0; null != (c = D[h]); h++)
                      if (c) {
                        var p = r ^ !!(l = F(c, o, h, D));
                        i && null != l ? p ? E = !0 : D[h] = !1 : p && (C.push(c),
                        E = !0)
                      }
                  if (l !== t) {
                    if (i || (D = C),
        ...
        var B = s.selectors = {
          ...
          relative: {
            ...
            ">": function(e, t) {
              ...
              if (n && !/\W/.test(t)) {
                ...
                for (i = 0,
                r = e.length; i < r; i++)
                  (o = e[i]) && (e[i] = n ? o.parentNode : o.parentNode === t);
                n && s.filter(t, e, !0)
              }
            },
            "": function(e, t, r) {
              ...
              if ("string" == typeof t && !/\W/.test(t)) {
                var C = t = t.toLowerCase();
                a = n
              }
              a("parentNode", t, E, e, C, r)
            },
            "~": function(e, t, r) {
              var E = o++
                , a = i;
          ...
          preFilter: {
            CLASS: function(e, t, n, i, r, o) {
              ...
              o)
                return e;
              o = 0;
              for (var E; null != (E = t[o]); o++)
                E && (r ^ (E.className && (" " + E.className + " ").replace(/[\t\n]/g, " ").indexOf(e) >= 0) ? n || i.push(E) : n && (t[o] = !1));
              return !1
            },
            ID: function(e) {
          ...
          filter: {
            PSEUDO: function(t, n, i, r) {
              ...
              s.error("Syntax error, unrecognized expression: " + o)
            },
            CHILD: function(e, t) {
              var n = t[1]
                , i = e;
        ...
        for (var u in B.match)
          B.match[u] = new RegExp(B.match[u].source + /(?![^\[]*\])(?![^\(]*\))/.source),
          B.leftMatch[u] = new RegExp(/(^(?:.|\r|\n)*?)/.source + B.match[u].source.replace(/\\(\d+)/g, function(e, t) {
            return "\\" + (t - 0 + 1)
          }));
        var A, l, c = function(e, t) {
        ...
        v.documentElement.compareDocumentPosition ? A = function(e, t) {
          return e.compareDocumentPosition && t.compareDocumentPosition ? (0 === (e = 4 & e.compareDocumentPosition(t) ? -1 : e === t ? 0 : 1) && (a = !0),
          e) : (e == t && (a = !0),
          e.compareDocumentPosition ? -1 : 1)
        }
        : "sourceIndex"in v.documentElement ? A = function(e, t) {
          return e.sourceIndex && t.sourceIndex ? (0 === (e = e.sourceIndex - t.sourceIndex) && (a = !0),
          e) : (e == t && (a = !0),
          e.sourceIndex ? -1 : 1)
        }
        : v.createRange && (A = function(e, t) {
          ...
          i.setStart(t, 0),
          i.setEnd(t, 0),
          0 === (e = n.compareBoundaryPoints(Range.START_TO_END, i)) && (a = !0),
          e
        }
        ),
        function() {
        ...
        (l = v.createElement("div")).appendChild(v.createComment("")),
        l.getElementsByTagName("*").length > 0 && (B.find.TAG = function(e, t) {
        ...
        l.firstChild && void 0 !== l.firstChild.getAttribute && "#" !== l.firstChild.getAttribute("href") && (B.attrHandle.href = function(e) {
        ...
        v.querySelectorAll && function() {
          ...
          !t.querySelectorAll || 0 !== t.querySelectorAll(".TEST").length) {
            for (var n in s = function(t, n, i, r) {
              if (n = n || v,
              !r && 9 === n.nodeType && !d(n))
                try {
        ...
        function() {
          ...
          1 !== e.getElementsByClassName("e").length && (B.order.splice(1, 0, "CLASS"),
        ...
        var F = v.compareDocumentPosition ? function(e, t) {
      ...
      p.fn.extend({
        ...
        not: function(e) {
          return this.pushStack(Ee(this, e, !1), "not", e)
        },
        filter: function(e) {
          return this.pushStack(Ee(this, e, !0), "filter", e)
        },
        is: function(e) {
        ...
        closest: function(e, t) {
          if (p.isArray(e)) {
            var n, i, r = [], o = this[0], E = {};
            if (o && e.length) {
              n = 0;
              for (var a = e.length; n < a; n++)
                E[i = e[n]] || (E[i] = p.expr.match.POS.test(i) ? p(i, t || this.context) : i);
              for (; o && o.ownerDocument && o !== t; ) {
                for (i in E)
                  ((n = E[i]).jquery ? n.index(o) > -1 : p(o).is(n)) && (r.push({
                    selector: i,
                    elem: o
                  }),
                  delete E[i]);
          ...
          var C = p.expr.match.POS.test(e) ? p(e, t || this.context) : null;
          return this.map(function(n, i) {
            for (; i && i.ownerDocument && i !== t; ) {
              if (C ? C.index(i) > -1 : p(i).is(e))
                return i;
              i = i.parentNode
            }
            return null
      ...
      p.fn.extend({
        ...
        clone: function(e) {
          var t = this.map(function() {
            ...
            e = e.innerHTML),
            p.clean([e.replace(ae, "").replace(/=([^="'>\s]+\/)>/g, '="$1">').replace(Ce, "")], t)[0]
          });
          return !0 === e && (A(this, t),
          A(this.find("*"), t.find("*"))),
          t
        ...
        html: function(e) {
          if (e === t)
            return this[0] && 1 === this[0].nodeType ? this[0].innerHTML.replace(ae, "") : null;
          if ("string" != typeof e || le.test(e) || !p.support.leadingWhitespace && Ce.test(e) || de[(De.exec(e) || ["", ""])[1].toLowerCase()])
        ...
        domManip: function(e, n, i) {
          ...
          var E, a, C, s = e[0], B = [];
          if (!p.support.checkClone && 3 === arguments.length && "string" == typeof s && ce.test(s))
            return this.each(function() {
          ...
          if (p.isFunction(s))
            return this.each(function(r) {
              var o = p(this);
              e[0] = s.call(this, r, n ? o.html() : t),
              o.domManip(e, n, i)
            });
          if (this[0]) {
            if (E = s && s.parentNode,
            a = 1 === (C = (E = p.support.parentNode && E && 11 === E.nodeType && E.childNodes.length === this.length ? {
              fragment: E
            } : l(e, this, B)).fragment).childNodes.length ? C = C.firstChild : C.firstChild) {
              n = n && p.nodeName(a, "tr");
              for (var D = 0, u = this.length; D < u; D++)
                i.call(n ? o(this[D]) : this[D], D > 0 || E.cacheable || this.length > 1 ? C.cloneNode(!0) : C)
            }
            B.length && p.each(B, r)
          }
          return this
      ...
      p.each({
        ...
        p.fn[e] = function(n) {
          ...
          r = 0;
          for (var o = n.length; r < o; r++) {
            var E = (r > 0 ? this.clone(!0) : this).get();
            p.fn[t].apply(p(n[r]), E),
            i = i.concat(E)
          }
      ...
      p.extend({
        clean: function(e, t, n, i) {
          ...
          for (var r, o = [], E = 0; null != (r = e[E]); E++)
            if ("number" == typeof r && (r += ""),
            r) {
              if ("string" != typeof r || Ae.test(r)) {
                if ("string" == typeof r) {
                  r = r.replace(se, Fe);
                  var a = (De.exec(r) || ["", ""])[1].toLowerCase()
                    , C = de[a] || de._default
                    , s = C[0]
                    , B = t.createElement("div");
                  for (B.innerHTML = C[1] + r + C[2]; s--; )
                    B = B.lastChild;
                  if (!p.support.tbody)
                    for (s = ue.test(r),
                    C = (a = "table" !== a || s ? "<table>" !== C[1] || s ? [] : B.childNodes : B.firstChild && B.firstChild.childNodes).length - 1; C >= 0; --C)
                      p.nodeName(a[C], "tbody") && !a[C].childNodes.length && a[C].parentNode.removeChild(a[C]);
                  !p.support.leadingWhitespace && Ce.test(r) && B.insertBefore(t.createTextNode(Ce.exec(r)[0]), B.firstChild),
                  r = B.childNodes
                }
              } else
          ...
          if (n)
            for (E = 0; o[E]; E++)
              !i || !p.nodeName(o[E], "script") || o[E].type && "text/javascript" !== o[E].type.toLowerCase() ? (1 === o[E].nodeType && o.splice.apply(o, [E + 1, 0].concat(p.makeArray(o[E].getElementsByTagName("script")))),
              n.appendChild(o[E])) : i.push(o[E].parentNode ? o[E].parentNode.removeChild(o[E]) : o[E]);
          return o
        },
        cleanData: function(e) {
          for (var t, n, i, r = p.cache, o = p.event.special, E = p.support.deleteExpando, a = 0; null != (i = e[a]); a++)
            if (n = i[p.expando]) {
              if ((t = r[n]).events)
                for (var C in t.events)
                  o[C] ? p.event.remove(i, C) : J(i, C, t.handle);
              E ? delete i[p.expando] : i.removeAttribute && i.removeAttribute(p.expando),
              delete r[n]
            }
        }
      });
      var he = /z-?index|font-?weight|opacity|zoom|line-?height/i
        ...
        , Te = p.support.cssFloat ? "cssFloat" : "styleFloat"
        , je = function(e, t) {
      ...
      p.extend({
        style: function(e, n, i) {
          ...
          var r = e.style || e
            , o = i !== t;
          return p.support.opacity || "opacity" !== n ? (me.test(n) && (n = Te),
          n = n.replace(ve, je),
          o && (r[n] = i),
          r[n]) : (o && (r.zoom = 1,
        ...
        curCSS: function(e, t, n) {
          ...
          !n && r && r[t])
            ...
            "opacity" === t && "" === i && (i = "1")
          } else if (e.currentStyle && (n = t.replace(ve, je),
        ...
        load: function(e, t, i) {
          ...
          return p.ajax({
            ...
            complete: function(e, t) {
              "success" !== t && "notmodified" !== t || E.html(o ? p("<div />").append(e.responseText.replace(Se, "")).find(o) : e.responseText),
              i && E.each(i, [e.responseText, t, e])
            }
          }),
          this
        },
      ...
      p.extend({
        ...
        ajax: function(n) {
          function i() {
            B.success && B.success.call(D, s, C, f),
            B.global && o("ajaxSuccess", [f, B])
          }
          function r() {
            B.complete && B.complete.call(D, f, C),
          ...
          var a, C, s, B = p.extend(!0, {}, p.ajaxSettings, n), D = n && n.context || B, u = B.type.toUpperCase();
          if (B.data && B.processData && "string" != typeof B.data && (B.data = p.param(B.data, B.traditional)),
          "jsonp" === B.dataType && ("GET" === u ? Pe.test(B.url) || (B.url += (Oe.test(B.url) ? "&" : "?") + (B.jsonp || "callback") + "=?") : B.data && Pe.test(B.data) || (B.data = (B.data ? B.data + "&" : "") + (B.jsonp || "callback") + "=?"),
          B.dataType = "json"),
          "json" === B.dataType && (B.data && Pe.test(B.data) || Pe.test(B.url)) && (a = B.jsonpCallback || "jsonp" + Ie++,
          B.data && (B.data = (B.data + "").replace(Pe, "=" + a + "$1")),
          B.url = B.url.replace(Pe, "=" + a + "$1"),
          B.dataType = "script",
          e[a] = e[a] || function(n) {
            s = n,
            i(),
          ...
          !1 === B.cache && "GET" === u) {
            var A = E()
              , l = B.url.replace(Re, "$1_=" + A + "$2");
            B.url = l + (l === B.url ? (Oe.test(B.url) ? "&" : "?") + "_=" + A : "")
          }
          if (B.data && "GET" === u && (B.url += (Oe.test(B.url) ? "&" : "?") + B.data),
          B.global && !p.active++ && p.event.trigger("ajaxStart"),
          A = (A = Le.exec(B.url)) && (A[1] && A[1] !== location.protocol || A[2] !== location.host),
          "script" === B.dataType && "GET" === u && A) {
          ...
          if (f) {
            ...
            try {
              ...
              B.ifModified && (p.lastModified[B.url] && f.setRequestHeader("If-Modified-Since", p.lastModified[B.url]),
              p.etag[B.url] && f.setRequestHeader("If-None-Match", p.etag[B.url])),
              A || f.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
            ...
            if (B.beforeSend && !1 === B.beforeSend.call(D, f, B))
              return B.global && !--p.active && p.event.trigger("ajaxStop"),
              f.abort(),
              !1;
            ...
            var m = f.onreadystatechange = function(e) {
              if (f && 0 !== f.readyState && "abort" !== e) {
                if (!h && f && (4 === f.readyState || "timeout" === e)) {
                  ...
                  "success" === (C = "timeout" === e ? "timeout" : p.httpSuccess(f) ? B.ifModified && p.httpNotModified(f, B.url) ? "notmodified" : "success" : "error"))
                    try {
                      s = p.httpData(f, B.dataType, B)
                    } catch (e) {
                      C = "parsererror",
                      t = e
                    }
                  "success" === C || "notmodified" === C ? a || i() : p.handleError(B, f, C, t),
                  r(),
                  "timeout" === e && f.abort(),
                  B.async && (f = null)
                }
        ...
        param: function(e, i) {
          function r(e, t) {
            p.isArray(t) ? p.each(t, function(t, E) {
              i || /\[\]$/.test(e) ? o(e, E) : r(e + "[" + ("object" === n(E) || p.isArray(E) ? t : "") + "]", E)
            }) : i || null == t || "object" !== n(t) ? o(e, t) : p.each(t, function(t, n) {
              r(e + "[" + t + "]", n)
            })
          }
          function o(e, t) {
          ...
          return E.join("&").replace(Ge, "+")
        }
      });
      var Ye, Qe = {}, We = /toggle|show|hide/, He = /^([+-]=)?([\d+-.]+)(.*)$/, Ze = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
      p.fn.extend({
        show: function(e, t) {
          if (e || 0 === e)
            return this.animate(c("show", 3), e, t);
          for (e = 0,
          t = this.length; e < t; e++) {
        ...
        hide: function(e, t) {
          if (e || 0 === e)
            return this.animate(c("hide", 3), e, t);
          for (e = 0,
          t = this.length; e < t; e++) {
            var n = p.data(this[e], "olddisplay");
        ...
        animate: function(e, t, n, i) {
          ...
          return p.isEmptyObject(e) ? this.each(r.complete) : this[!1 === r.queue ? "each" : "queue"](function() {
            var t, n = p.extend({}, r), i = 1 === this.nodeType && p(this).is(":hidden"), o = this;
            for (t in e) {
              var E = t.replace(ve, je);
              if (t !== E && (e[E] = e[t],
              delete e[t],
              t = E),
            ...
            p.each(e, function(t, r) {
              var E = new p.fx(o,n,t);
              if (We.test(r))
                E["toggle" === r ? i ? "show" : "hide" : r](e);
              else {
                var a = He.exec(r)
                  , C = E.cur(!0) || 0;
                if (a) {
      ...
      p.fn.offset = "getBoundingClientRect"in v.documentElement ? function(e) {
        var t = this[0];
        if (e)
          return this.each(function(t) {
      ...
      : function(e) {
        ...
        if (t === t.ownerDocument.body)
          return p.offset.bodyOffset(t);
        p.offset.initialize();
        var n, i = t.offsetParent, r = t, o = t.ownerDocument, E = o.documentElement, a = o.body;
        r = (o = o.defaultView) ? o.getComputedStyle(t, null) : t.currentStyle;
        for (var C = t.offsetTop, s = t.offsetLeft; (t = t.parentNode) && t !== a && t !== E && (!p.offset.supportsFixedPosition || "fixed" !== r.position); )
          n = o ? o.getComputedStyle(t, null) : t.currentStyle,
          C -= t.scrollTop,
          s -= t.scrollLeft,
          t === i && (C += t.offsetTop,
          s += t.offsetLeft,
          !p.offset.doesNotAddBorder || p.offset.doesAddBorderForTableAndCells && /^t(able|d|h)$/i.test(t.nodeName) || (C += parseFloat(n.borderTopWidth) || 0,
          s += parseFloat(n.borderLeftWidth) || 0),
          r = i,
          i = t.offsetParent),
          p.offset.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (C += parseFloat(n.borderTopWidth) || 0,
          s += parseFloat(n.borderLeftWidth) || 0),
          r = n;
        return "relative" !== r.position && "static" !== r.position || (C += a.offsetTop,
        s += a.offsetLeft),
        p.offset.supportsFixedPosition && "fixed" === r.position && (C += Math.max(E.scrollTop, a.scrollTop),
        s += Math.max(E.scrollLeft, a.scrollLeft)),
        {
          top: C,
          left: s
        }
      ...
      p.offset = {
        initialize: function() {
          var e, t, n, i = v.body, r = v.createElement("div"), o = parseFloat(p.curCSS(i, "marginTop", !0)) || 0;
          p.extend(r.style, {
            position: "absolute",
            top: 0,
            left: 0,
        ...
        setOffset: function(e, t, n) {
          ...
          var i = p(e)
            ...
            , E = parseInt(p.curCSS(e, "left", !0), 10) || 0;
          p.isFunction(t) && (t = t.call(e, n, r)),
          n = {
            top: t.top - r.top + o,
            left: t.left - r.left + E
          },
      ...
      p.fn.extend({
        ...
        offsetParent: function() {
          return this.map(function() {
            for (var e = this.offsetParent || v.body; e && !/^body|html$/i.test(e.nodeName) && "static" === p.css(e, "position"); )
              e = e.offsetParent;
            return e
          })
        }
  ...
  , function(e, t) {
    ...
    !function() {
      ...
      t.prototype = {
        ...
        createMovieClip: function(e, t, n) {
          ...
          for (var r = 0; r < this.modules.length; r++)
            for (var o = 1 * r, E = 0; E < this.modules[r].length; E++) {
              var a = 1 * E;
              this.modules[r][E] && (i.beginFill(0, 100),
              i.moveTo(a, o),
              i.lineTo(a + 1, o),
              i.lineTo(a + 1, o + 1),
              i.lineTo(a, o + 1),
          ...
          for (var e = A.getPatternPosition(this.typeNumber), t = 0; t < e.length; t++)
            for (var n = 0; n < e.length; n++) {
              ...
              if (null == this.modules[i][r])
                for (var o = -2; o <= 2; o++)
                  for (var E = -2; E <= 2; E++)
                    this.modules[i + o][r + E] = -2 == o || 2 == o || -2 == E || 2 == E || 0 == o && 0 == E
            }
        },
        ...
        setupTypeInfo: function(e, t) {
          for (var n = this.errorCorrectLevel << 3 | t, i = A.getBCHTypeInfo(n), r = 0; r < 15; r++) {
            var o = !e && 1 == (i >> r & 1);
        ...
        mapData: function(e, t) {
          for (var n = -1, i = this.moduleCount - 1, r = 7, o = 0, E = this.moduleCount - 1; E > 0; E -= 2)
            for (6 == E && E--; ; ) {
              for (var a = 0; a < 2; a++)
                if (null == this.modules[i][E - a]) {
                  var C = !1;
                  o < e.length && (C = 1 == (e[o] >>> r & 1)),
                  A.getMask(t, i, E - a) && (C = !C),
                  this.modules[i][E - a] = C,
                  -1 == --r && (o++,
                  r = 7)
                }
      ...
      t.createData = function(e, n, i) {
        for (var r = d.getRSBlocks(e, n), o = new h, E = 0; E < i.length; E++) {
          var a = i[E];
          o.put(a.mode, 4),
          o.put(a.getLength(), A.getLengthInBits(a.mode, e)),
          a.write(o)
        }
        var C = 0;
        ...
        for (o.getLengthInBits() + 4 <= 8 * C && o.put(0, 4); o.getLengthInBits() % 8 != 0; )
          o.putBit(!1);
        for (; !(o.getLengthInBits() >= 8 * C || (o.put(t.PAD0, 8),
      ...
      t.createBytes = function(e, t) {
        for (var n = 0, i = 0, r = 0, o = new Array(t.length), E = new Array(t.length), a = 0; a < t.length; a++) {
          var C = t[a].dataCount
            , s = t[a].totalCount - C;
          i = Math.max(i, C),
          r = Math.max(r, s),
          o[a] = new Array(C);
          for (var B = 0; B < o[a].length; B++)
            o[a][B] = 255 & e.buffer[B + n];
          n += C;
          var D = A.getErrorCorrectPolynomial(s)
            , u = new F(o[a],D.getLength() - 1).mod(D);
          E[a] = new Array(D.getLength() - 1);
          for (B = 0; B < E[a].length; B++) {
            var l = B + u.getLength() - E[a].length;
            E[a][B] = l >= 0 ? u.get(l) : 0
          }
        }
        var c = 0;
        ...
        for (B = 0; B < i; B++)
          for (a = 0; a < t.length; a++)
            B < o[a].length && (d[h++] = o[a][B]);
        for (B = 0; B < r; B++)
          for (a = 0; a < t.length; a++)
            B < E[a].length && (d[h++] = E[a][B]);
        return d
      }
      ;
      for (var i = {
        ...
        getErrorCorrectPolynomial: function(e) {
          for (var t = new F([1],0), n = 0; n < e; n++)
            t = t.multiply(new F([1, l.gexp(n)],0));
          return t
        },
        ...
        getLostPoint: function(e) {
          for (var t = e.getModuleCount(), n = 0, i = 0; i < t; i++)
            for (var r = 0; r < t; r++) {
              for (var o = 0, E = e.isDark(i, r), a = -1; a <= 1; a++)
                if (!(i + a < 0 || t <= i + a))
                  for (var C = -1; C <= 1; C++)
                    r + C < 0 || t <= r + C || 0 == a && 0 == C || E == e.isDark(i + a, r + C) && o++;
              o > 5 && (n += 3 + o - 5)
            }
          for (i = 0; i < t - 1; i++)
            for (r = 0; r < t - 1; r++) {
      ...
      d.getRSBlocks = function(e, t) {
        ...
        for (var i = n.length / 3, r = [], o = 0; o < i; o++)
          for (var E = n[3 * o + 0], a = n[3 * o + 1], C = n[3 * o + 2], s = 0; s < E; s++)
            r.push(new d(a,C));
        return r
      }
      ,
      ...
      var m = function() {
        ...
        , v = "svg" === document.documentElement.tagName.toLowerCase() ? m : "undefined" == typeof CanvasRenderingContext2D ? function() {
        var e = function(e, t) {
          this._el = e,
          this._htOption = t
        };
        return e.prototype.draw = function(e) {
          for (var t = this._htOption, n = this._el, i = e.getModuleCount(), r = Math.floor(t.width / i), o = Math.floor(t.height / i), E = ['<table style="border:0;border-collapse:collapse;">'], a = 0; a < i; a++) {
            E.push("<tr>");
            for (var C = 0; C < i; C++)
              E.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + r + "px;height:" + o + "px;background-color:" + (e.isDark(a, C) ? t.colorDark : t.colorLight) + ';"></td>');
            E.push("</tr>")
          }
          E.push("</table>"),
          n.innerHTML = E.join("");
          var s = n.childNodes[0]
            , B = (t.width - s.offsetWidth) / 2
            , D = (t.height - s.offsetHeight) / 2;
          B > 0 && D > 0 && (s.style.margin = D + "px " + B + "px")
        }
        ,
        e.prototype.clear = function() {
          this._el.innerHTML = ""
        ...
        return r.prototype.draw = function(e) {
          ...
          for (var s = 0; s < r; s++)
            for (var B = 0; B < r; B++) {
              ...
              n.fillRect(u, A, o, E),
              n.strokeRect(Math.floor(u) + .5, Math.floor(A) + .5, a, C),
              n.strokeRect(Math.ceil(u) - .5, Math.ceil(A) - .5, a, C)
            }
          this._bIsPainted = !0
        }
        ,
  ...
  , function(e, t, n) {
    ...
    function T() {
      return T.seed = (9301 * T.seed + 49297) % 233280,
      T.seed / 233280
    }
    function j(e, t, n) {
    ...
    function N(e, t, n, i, o, C, B) {
      var D = l()
        , u = c();
      if (b = 0,
      "iPhone" == u || "iPad" == u || "iPod" == u)
        r(e);
      else if ("MacBrowser" == D)
        a.productMacShow(e, i, !1, e);
      else if ("Android" == D)
        E.productAndroidShow(e, i);
      else {
        X(),
        V(1, i),
        i = i || "",
        ...
        ne.pId = i || "";
        try {
          B = "coWebThunder" == s ? 3 : "coThunder5" == s ? 4 : 5
        } catch (e) {
          B && !isNaN(B) && (B = Number(B))
        }
        if (3 != B && 4 != B || (ne.thunderType = B),
        "boolean" != typeof o && 2 != (o = isNaN(o) ? void 0 : Number(o)) && 10 != o && (o = void 0),
        1 != o && 10 != o || null == o ? 0 != o && 2 != o || null == o || (ne.isOpenNew = !1) : ne.isOpenNew = !0,
        x)
          return v.load_pc_xunlei_success(e),
          ne.download(e, n, "", "");
        re(e, i)
      }
      return !1
    ...
    function P(e, t, n, C) {
      ...
      var s = ""
        , D = l()
        , A = c();
      "" == s && (null != (s = e.getAttribute(B)) && "" != s || (s = e.getAttribute("thunderHref")));
      location.href;
      ...
      "iPhone" == A || "iPad" == A || "iPod" == A) {
        ...
        a.productMacShow(s, d, !1, s);
      else if ("Android" == D)
        E.productAndroidShow(s, d);
      else {
        if (!F())
          return M(s, d),
          !1;
        u.getIEVersion();
        o(d, function(e) {
          e && _(e, "9.0.0.0") >= 0 ? (v.load_pc_xunlei_success(s),
          i({
            thunderPid: d,
            url: s
          }, function() {
          ...
          m.copyText(s),
          m.fn = oe(s).split("?")[0].split("/").pop(),
          m.popup("not_install_on_win", s, !1, !1))
        })
      }
      return !1
    }
    var O, R = "#ba2020", L = "#5bb956", G = "", U = navigator.appVersion.indexOf("MSIE 6") > -1;
    ...
    function Z(e, t) {
      ...
      j_xunlei_q.ajax({
        ...
        success: function(e) {
          try {
            0 == e.status ? (j_xunlei_q(".thunder_m_tip #thunder_m_note").css("color", L).html("\u77ed\u4fe1\u5df2\u53d1\u9001\uff0c\u53ef\u80fd\u67093-5\u5206\u949f\u5ef6\u8fdf").show(),
            j_xunlei_q("#thunder_m_phone").removeClass("thunder_m_on1").val("\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d"),
            J(5)) : (j_xunlei_q("#thunder_m_send_sms").addClass("thunder_m_on"),
            j_xunlei_q("#thunder_m_send_sms").removeAttr("disabled"),
            j_xunlei_q(".thunder_m_tip #thunder_m_note").css("color", R).html(e.msg).show()),
    ...
    function V(e, t) {
      !function(e, t, n) {
        try {
          var i = "http://stat.download.xunlei.com:8080/?aid=" + e + "&id=" + t + "&f=" + n + "&peerid=" + I(w) + "&click=1&_t=" + (new Date).getTime();
          (new Image).src = i
        } catch (e) {}
      }(1030, e, t)
    }
    ...
    var ne = {
      ...
      setParameter: function(e, t, n, i) {
        e = e || this.pId;
        for (var r, o = ["thunder_cid", "thunder_down_url", "thunder_down_pageurl", "thunder_stat_pageurl"], E = 0; E < o.length; E++)
          k(r = j_xunlei_q(o[E])) && ((r = document.createElement("input")).type = "hidden",
          r.id = o[E],
          d(),
      ...
      download: function(e, t, n, i, r) {
        var o;
        if (o = this.getInstance(),
        this.pId = this.pId ? this.pId : r || "",
        r = r || this.pId,
        o)
          if (this.isIE)
            o.download(r, e, t, n, i);
          else
    ...
    function re(e, t) {
      ...
      if ("Safari" != l()) {
        ...
        E.type = "application/np_xunlei_plugin",
        E.width = 0,
        E.height = 0,
        d(),
        document.body.appendChild(E),
        r && E.DownLoadByThunderPlugin ? (v.load_pc_xunlei_success(e),
        E.DownLoadByThunderPlugin(e)) : (V(2, t),
        n())
      } else
        V(2, t),
        n()
    ...
    ne.ffThunder.prototype = {
      ...
      download: function(e, t, n, i, r, o) {
        netscape.security.PrivilegeManager.enablePrivilege("UniversalXPConnect"),
        o = o || 2;
        var E = this.getClientType();
        3 == E && (E = o),
        1 == E && (e = ""),
        i = i || "",
        r = r || "",
        this.__thObj.CallThunderClient(E, t, n, r, "", i, e, document.cookie)
      }
    },
    ...
    window.OnDownloadClick_Company = function(e, t, n, i, r, o, E, a) {
      return ne.companySetup(a, i),
      N(e, t, n, i, r, o, E),
      !1
    }
    ,
    ...
    window.OnDownloadClick_Simple = function(e, t, n, i) {
      ...
      e.getAttribute("thunderHref"))
        ...
        o = e.getAttribute(B);
      var E = o.split("?")[0].split("/").pop()
        , a = j_xunlei_q.inArray(E, ["avi", "rmvb", "rm", "divx", "mpg", "mpeg", "wmv", "mp4", "mkv"]) > -1 ? 1 : 0;
        ...
        D) {
          (function() {
            ...
            j_xunlei_q("#union_download_thunder").unbind("click").click(function() {
              var e = l();
              return "Firefox" == e || "Chrome" == e || "SB360" == e ? re(D, a) : "unknown" == e ? alert(unescape("\u62b1\u6b49\uff0c\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u8fc5\u96f7\u4e13\u7528\u94fe\u4e0b\u8f7d\uff0c\u8bf7\u66f4\u6362\u522b\u7684\u6d4f\u89c8\u5668\u5982IE9\u518d\u8bd5")) : N(D, 0, location.href, a, !1, ""),
              q(),
              J(6),
              !1
            }),
            ...
            j_xunlei_q("#thunder_m_phone").unbind().focus(function() {
              "\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d" == j_xunlei_q("#thunder_m_phone").val() && (j_xunlei_q("#thunder_m_phone").val(""),
              j_xunlei_q("#thunder_m_phone").addClass("thunder_m_on1"))
            }).blur(function() {
              "" == j_xunlei_q("#thunder_m_phone").val() && (j_xunlei_q("#thunder_m_phone").removeClass("thunder_m_on1"),
              j_xunlei_q("#thunder_m_phone").val("\u8f93\u5165\u624b\u673a\u53f7\uff0c\u514d\u8d39\u4e0b\u8f7d"))
            }),
            j_xunlei_q("#thunder_m_valid").unbind().focus(function() {
              "\u8f93\u5165\u9a8c\u8bc1\u7801" == j_xunlei_q("#thunder_m_valid").val() && (j_xunlei_q("#thunder_m_valid").val(""),
              j_xunlei_q("#thunder_m_valid").addClass("thunder_m_on1"))
            }).blur(function() {
              "" == j_xunlei_q("#thunder_m_valid").val() && (j_xunlei_q("#thunder_m_valid").removeClass("thunder_m_on1"),
              j_xunlei_q("#thunder_m_valid").val("\u8f93\u5165\u9a8c\u8bc1\u7801"))
            }),
            j_xunlei_q("#thunder_m_phone").unbind("keyup").keyup(function() {
              var e = j_xunlei_q("#thunder_m_phone").val();
              /^(\+86)?(13[0-9]|15[0-9]|18[0-9]|147)\d{8}$/.test(e) ? (j_xunlei_q("#thunder_m_send_sms").addClass("thunder_m_on"),
              j_xunlei_q("#thunder_m_send_sms").removeAttr("disabled")) : (j_xunlei_q("#thunder_m_send_sms").removeClass("thunder_m_on"),
            ...
            j_xunlei_q("#thunder_m_send_sms").unbind("click").click(function() {
              ...
              !/^(\+86)?(13[0-9]|15[0-9]|18[0-9]|147)\d{8}$/.test(e))
                return j_xunlei_q(".thunder_m_tip #thunder_m_note").css("color", R).html("\u60a8\u7684\u624b\u673a\u53f7\u7801\u65e0\u6548").show(),
                !1;
              var t = j_xunlei_q(".thunder_m_tip #thunder_m_valid").val();
              if ("\u8f93\u5165\u9a8c\u8bc1\u7801" == t)
                return j_xunlei_q(".thunder_m_tip  #thunder_m_note").css("color", R).html("\u8bf7\u8f93\u5165\u9a8c\u8bc1\u7801").show(),
                j_xunlei_q(".thunder_m_tip #thunder_m_valid").focus(),
                !1;
              if (4 != t.length)
                return j_xunlei_q(".thunder_m_tip  #thunder_m_note").css("color", R).html("\u9a8c\u8bc1\u7801\u9519\u8bef").show(),
                j_xunlei_q(".thunder_m_tip #thunder_m_valid").focus(),
                !1;
              var n = j_xunlei_q("#thunder_m_short_url").val()
                , i = j_xunlei_q("#thunder_m_client_checkcode").val();
              if ("" == n)
                return j_xunlei_q(".thunder_m_tip #thunder_m_note").css("color", R).html("\u77ed\u4fe1\u53d1\u9001\u5931\u8d25").show(),
                !1;
            ...
            var r = A()
              ...
              , E = r.clientHeight / 2 - 200
              , C = "fixed";
            (U || "backcompat" == document.compatMode.toLowerCase()) && (C = "absolute",
            o = r.clientWidth / 2 - 200 + document.documentElement.scrollLeft + document.body.scrollLeft,
            E = r.clientHeight / 2 - 180 + document.documentElement.scrollTop + document.body.scrollTop,
            u.style.top = Math.max(document.documentElement.scrollTop, document.body.scrollTop)),
            i.css({
              left: o,
              top: E,
              position: C,
          ...
          (U || "backcompat" == document.compatMode.toLowerCase()) && (u.style.height = Math.max(document.body.clientHeight, document.documentElement.clientHeight),
          j_xunlei_q(window).unbind("scroll").scroll(function() {
    ...
    j_xunlei_q(document).ready(function() {
      ...
      "Android" == l() && j_xunlei_q("a[" + B + "]").each(function() {
        var e = j_xunlei_q(this);
  ...
  , function(e, t) {
    e.exports = function(e) {
      ...
      function n(e, t) {
        ...
        (n = 1073741824 & e) & (i = 1073741824 & t) ? 2147483648 ^ E ^ r ^ o : n | i ? 1073741824 & E ? 3221225472 ^ E ^ r ^ o : 1073741824 ^ E ^ r ^ o : E ^ r ^ o
      }
      function i(e, i, r, o, E, a, C) {
        var s;
        return e = n(e, n(n((s = i) & r | ~s & o, E), C)),
        n(t(e, a), i)
      }
      function r(e, i, r, o, E, a, C) {
        var s;
        return e = n(e, n(n(i & (s = o) | r & ~s, E), C)),
        n(t(e, a), i)
      }
      function o(e, i, r, o, E, a, C) {
        return e = n(e, n(n(i ^ r ^ o, E), C)),
        n(t(e, a), i)
      }
      function E(e, i, r, o, E, a, C) {
        return e = n(e, n(n(r ^ (i | ~o), E), C)),
        n(t(e, a), i)
      }
      function a(e) {
        var t, n = "", i = "";
      ...
      var C, s, B, D, u, A, l, c, F, d = Array();
      for (d = function(e) {
        for (var t, n = e.length, i = n + 8, r = 16 * ((i - i % 64) / 64 + 1), o = Array(r - 1), E = 0, a = 0; a < n; )
          E = a % 4 * 8,
          o[t = (a - a % 4) / 4] = o[t] | e.charCodeAt(a) << E,
          a++;
        return E = a % 4 * 8,
        o[t = (a - a % 4) / 4] = o[t] | 128 << E,
        o[r - 2] = n << 3,
        o[r - 1] = n >>> 29,
        o
      }(e = function(e) {
      ...
      C = 0; C < d.length; C += 16)
        ...
        D = c,
        u = F,
        A = i(A, l, c, F, d[C + 0], 7, 3614090360),
        F = i(F, A, l, c, d[C + 1], 12, 3905402710),
        c = i(c, F, A, l, d[C + 2], 17, 606105819),
        l = i(l, c, F, A, d[C + 3], 22, 3250441966),
        A = i(A, l, c, F, d[C + 4], 7, 4118548399),
        F = i(F, A, l, c, d[C + 5], 12, 1200080426),
        c = i(c, F, A, l, d[C + 6], 17, 2821735955),
        l = i(l, c, F, A, d[C + 7], 22, 4249261313),
        A = i(A, l, c, F, d[C + 8], 7, 1770035416),
        F = i(F, A, l, c, d[C + 9], 12, 2336552879),
        c = i(c, F, A, l, d[C + 10], 17, 4294925233),
        l = i(l, c, F, A, d[C + 11], 22, 2304563134),
        A = i(A, l, c, F, d[C + 12], 7, 1804603682),
        F = i(F, A, l, c, d[C + 13], 12, 4254626195),
        c = i(c, F, A, l, d[C + 14], 17, 2792965006),
        A = r(A, l = i(l, c, F, A, d[C + 15], 22, 1236535329), c, F, d[C + 1], 5, 4129170786),
        F = r(F, A, l, c, d[C + 6], 9, 3225465664),
        c = r(c, F, A, l, d[C + 11], 14, 643717713),
        l = r(l, c, F, A, d[C + 0], 20, 3921069994),
        A = r(A, l, c, F, d[C + 5], 5, 3593408605),
        F = r(F, A, l, c, d[C + 10], 9, 38016083),
        c = r(c, F, A, l, d[C + 15], 14, 3634488961),
        l = r(l, c, F, A, d[C + 4], 20, 3889429448),
        A = r(A, l, c, F, d[C + 9], 5, 568446438),
        F = r(F, A, l, c, d[C + 14], 9, 3275163606),
        c = r(c, F, A, l, d[C + 3], 14, 4107603335),
        l = r(l, c, F, A, d[C + 8], 20, 1163531501),
        A = r(A, l, c, F, d[C + 13], 5, 2850285829),
        F = r(F, A, l, c, d[C + 2], 9, 4243563512),
        c = r(c, F, A, l, d[C + 7], 14, 1735328473),
        A = o(A, l = r(l, c, F, A, d[C + 12], 20, 2368359562), c, F, d[C + 5], 4, 4294588738),
        F = o(F, A, l, c, d[C + 8], 11, 2272392833),
        c = o(c, F, A, l, d[C + 11], 16, 1839030562),
        l = o(l, c, F, A, d[C + 14], 23, 4259657740),
        A = o(A, l, c, F, d[C + 1], 4, 2763975236),
        F = o(F, A, l, c, d[C + 4], 11, 1272893353),
        c = o(c, F, A, l, d[C + 7], 16, 4139469664),
        l = o(l, c, F, A, d[C + 10], 23, 3200236656),
        A = o(A, l, c, F, d[C + 13], 4, 681279174),
        F = o(F, A, l, c, d[C + 0], 11, 3936430074),
        c = o(c, F, A, l, d[C + 3], 16, 3572445317),
        l = o(l, c, F, A, d[C + 6], 23, 76029189),
        A = o(A, l, c, F, d[C + 9], 4, 3654602809),
        F = o(F, A, l, c, d[C + 12], 11, 3873151461),
        c = o(c, F, A, l, d[C + 15], 16, 530742520),
        A = E(A, l = o(l, c, F, A, d[C + 2], 23, 3299628645), c, F, d[C + 0], 6, 4096336452),
        F = E(F, A, l, c, d[C + 7], 10, 1126891415),
        c = E(c, F, A, l, d[C + 14], 15, 2878612391),
        l = E(l, c, F, A, d[C + 5], 21, 4237533241),
        A = E(A, l, c, F, d[C + 12], 6, 1700485571),
        F = E(F, A, l, c, d[C + 3], 10, 2399980690),
        c = E(c, F, A, l, d[C + 10], 15, 4293915773),
        l = E(l, c, F, A, d[C + 1], 21, 2240044497),
        A = E(A, l, c, F, d[C + 8], 6, 1873313359),
        F = E(F, A, l, c, d[C + 15], 10, 4264355552),
        c = E(c, F, A, l, d[C + 6], 15, 2734768916),
        l = E(l, c, F, A, d[C + 13], 21, 1309151649),
        A = E(A, l, c, F, d[C + 4], 6, 4149444226),
        F = E(F, A, l, c, d[C + 11], 10, 3174756917),
        c = E(c, F, A, l, d[C + 2], 15, 718787259),
        l = E(l, c, F, A, d[C + 9], 21, 3951481745),
        A = n(A, s),
        l = n(l, B),
        c = n(c, D),
        F = n(F, u);
      return (a(A) + a(l) + a(c) + a(F)).toLowerCase()
    }
  }
  , function(e, t) {
  ...
  , function(e, t, n) {
    (function(t, i) {
      ...
      r = function() {
        ...
        ) : A ? ((d = new MessageChannel).port1.onmessage = F,
        m = function() {
          ...
          try {
            var e = n(39);
            return E = e.runOnLoop || e.runOnContext,
            function() {
              E(F)
            }
          } catch (e) {
        ...
        function j(t, n, i) {
          n.constructor === t.constructor && i === v && n.constructor.resolve === g ? function(e, t) {
            t._state === w ? N(e, t._result) : t._state === x ? M(e, t._result) : P(t, void 0, function(t) {
              return I(e, t)
            }, function(t) {
              return M(e, t)
            })
          }(t, n) : i === k ? M(t, k.error) : void 0 === i ? N(t, n) : e(i) ? function(e, t, n) {
            C(function(e) {
              var i = !1
                , r = function(e, t, n, i) {
                try {
        ...
        function I(e, t) {
          var n;
          e === t ? M(e, new TypeError("You cannot resolve a promise with itself")) : "function" == typeof (n = t) || "object" == typeof n && null !== n ? j(e, t, T(t)) : N(e, t)
        }
        function S(e) {
        ...
        function N(e, t) {
          ...
          e._state = w,
          0 !== e._subscribers.length && C(O, e))
        }
        function M(e, t) {
          e._state === b && (e._state = x,
          e._result = t,
          C(S, e))
        }
        function P(e, t, n, i) {
        ...
        function O(e) {
          var t = e._subscribers
            , n = e._state;
          if (0 !== t.length) {
            for (var i = void 0, r = void 0, o = e._result, E = 0; E < t.length; E += 3)
              i = t[E],
              r = t[E + n],
              i ? G(n, i, r, o) : r(o);
        ...
        function G(t, n, i, r) {
          ...
          if (o) {
            ...
            E = r,
            C = !0;
          n._state !== b || (o && C ? I(n, E) : s ? M(n, a) : t === w ? N(n, E) : t === x && M(n, E))
        }
        var U = 0;
        function Y(e) {
          e[_] = U++,
        ...
        function Q(e, t) {
          ...
          0 === this.length ? N(this.promise, this._result) : (this.length = this.length || 0,
          this._enumerate(),
          0 === this._remaining && N(this.promise, this._result))) : M(this.promise, new Error("Array Methods must be provided an Array"))
        }
        function W(e) {
          this[_] = U++,
          this._result = this._state = void 0,
          this._subscribers = [],
          y !== e && ("function" != typeof e && function() {
  ...
  , function(e, t, n) {
    ...
    (function(t) {
      ...
      e.exports = function(e) {
        ...
        (e.adapter || E.adapter)(e).then(function(t) {
          return a(e),
          t.data = r(t.data, t.headers, e.transformResponse),
          t
        }, function(n) {
          return o(n) || (a(e),
          n && n.response && (n.response.data = r(n.response.data, n.response.headers, e.transformResponse))),
          t.reject(n)
        })
      }
    }
  ...
  , function(e, t, n) {
    ...
    e.exports = function(e) {
      ...
      return e ? (i.forEach(e.split("\n"), function(e) {
        ...
        t) {
          if (E[t] && r.indexOf(t) >= 0)
            return;
          E[t] = "set-cookie" === t ? (E[t] ? E[t] : []).concat([n]) : E[t] ? E[t] + ", " + n : n
        }
      }),
      E) : E
    }
  ...
  , function(e, t, n) {
    ...
    n(12))
      , E = n(13);
    e.exports = {
      saveToCloudPan: function(e, t, n, a) {
        var C = navigator.userAgent.toLowerCase();
        if (!/ithunder/i.test(C))
          return function(e) {
            var t = e.url
              , n = e.name
              , a = e.unionId;
            ...
            i.openComfirm({
              ...
              comfirmHandler: function() {
                ...
                window.location.href = "".concat("https://pan.xunlei.com/", "?taskurl=").concat(decodeURIComponent(t), "&unionId=").concat(a)
              }
            })
          }({
            url: t,
  ...
  , function(e, t, n) {
    ...
    function D(e, t, n) {
      var a = arguments[0]
        ...
        , A = void 0 !== arguments[3] ? arguments[3] : null
      ...
      if (p.indexOf(D.LINK) < 0 && (p += D.LINK),
      null == A)
        try {
          A = thunderAppend
        } catch (e) {
      ...
      if (void 0 === a || null == a) {
        ...
        if ("" == a || null == typeof a || isNaN(a))
          return D.isDebug && alert("Pid is not provided!"),
          !1
      }
      if (null == s || void 0 === s)
        try {
      ...
      "Android" == E() && (_ = /^http:\/\/|https:\/\/|ftp:\/\/|magnet:|ed2k:|mms:\/\/[\s\S]*?$/i);
      var b = g.length
        , w = 0
        , x = 0;
      F <= 0 && (F = b);
      for (var k = 0; k < b; k++)
        if (g[k + w].href) {
          if ("" != c)
            if ("string" == typeof c) {
              if (g[k + w].href.indexOf(c) >= 0)
                continue
            } else if (c.test && null != g[k + w].href.match(c))
              continue;
          var T = g[k + w].getAttribute(m);
          if ("#" == g[k + w].href.substr(g[k + w].href.length - 1, 1) && T) {
            D.isDebug && (alert("ThunderHref:" + T),
            alert("href:" + g[k + w].href));
            continue
          }
          if (B)
            var j = window.encodeURI(g[k + w].href);
          else
            j = g[k + w].href;
          var I = ""
            , S = "";
          if (0 == j.indexOf("thunder://"))
            S = j,
            D.isDebug && alert("thunderLinker![" + S + "]");
          else if (_.test(j))
            I = y.test(j) ? j.indexOf("?") > 0 ? j + "&" + C(j) : j + "?" + C(j) : j;
          else if ("" != s && null != s)
            if ("string" == typeof s)
              j.toLowerCase().indexOf("/" + s) > -1 && (I = j,
              D.isDebug && alert("other://String Path Valid!"));
            else if (s.test) {
              var N = s.test(j);
              j.indexOf("attachment") > 0 && D.isDebug && alert(String(s) + ".test('" + j + "')=" + String(N)),
              null != j.match(s) ? (I = j,
              D.isDebug && alert("**********************RegEx*********************")) : D.isDebug && alert("other://Reg Path Invalid!\n[" + s + "]" + j + "||||<" + String(N) + ">||||")
            }
          if ("" != I && (S = i(I)),
          "" != S) {
            var M = g[k + w];
            if ("" != u ? A && "" != I ? "" != I && (g[k + w].insertAdjacentHTML(f, p.replace(D.LINK, h + "<a class='" + M.className + "' target='_self' href='#' title='" + l + "' " + m + "='" + S + "' thunderPid='" + a + "' thunderType='' thunderResTitle='' onClick='return OnDownloadClick_Simple(this,2)' oncontextmenu='ThunderNetwork_SetHref(this)'>" + u.replace(D.TITLE, M.innerHTML) + "</a>") + d),
            w++,
            x++) : (M.setAttribute("thunderPid", a),
            ...
            M.setAttribute(m, S),
            x++) : A && "" != I ? "" != I && (g[k + w].insertAdjacentHTML(f, p.replace(D.LINK, h + "<a class='" + M.className + "' target='_self' href='#' title='" + l + "' " + m + "='" + S + "' thunderPid='" + a + "' thunderType='' thunderResTitle='' onClick='return OnDownloadClick_Simple(this,2)' oncontextmenu='ThunderNetwork_SetHref(this)'><font color='red'>" + l + "</font></a>") + d),
            w++,
            x++) : (M.setAttribute("thunderPid", a),
            M.setAttribute("thunderType", ""),
            M.setAttribute("thunderResTitle", M.innerHTML),
    ...
    D.auto = !0,
    s && (document.onreadystatechange = function() {
  ...
  , function(e, t) {
    ...
    function i(e) {
      return function(e) {
        ...
        for (var t = e, n = Array(80), i = 1732584193, C = -271733879, s = -1732584194, B = 271733878, D = -1009589776, u = 0; u < t.length; u += 16) {
          for (var A = i, l = C, c = s, F = B, d = D, h = 0; h < 80; h++) {
            n[h] = h < 16 ? t[u + h] : a(n[h - 3] ^ n[h - 8] ^ n[h - 14] ^ n[h - 16], 1);
            var p = E(E(a(i, 5), r(h, C, s, B)), E(E(D, n[h]), o(h)));
            D = B,
            B = s,
            s = a(C, 30),
            C = i,
