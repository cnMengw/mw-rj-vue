...
$filePathPhp  = $_SERVER["DOCUMENT_ROOT"].str_replace("/xdf-mock-api","",$dirArray[0])."/index.php";
$filePathJson = $_SERVER["DOCUMENT_ROOT"].str_replace("/xdf-mock-api","",$dirArray[0])."/index.json";
